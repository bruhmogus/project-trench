job-name-class-d = Class D Personnel
job-name-class-d-cook = Class D Cook
job-name-class-d-botanist = Class D Botanist
job-name-class-d-janitor = Class D Janitor
job-description-class-d = You know what that D stands for? Disposable. You will be used for experiments, and it'll probably kill you. Good luck.
