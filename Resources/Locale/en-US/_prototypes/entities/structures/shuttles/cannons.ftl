...
ent-ShuttleGunBullfrog = EXP-3600g "Bullfrog"
    .desc = A powerful 40mm stationary automatic grenade launcher. A cartridge is required for use.
...
ent-ShuttleGunLongbow = BAL-15 "Longbow"
...
ent-ShuttleGunQuadling = BAL-15-4 "Quadling"
    ...
    .suffix = DO NOT MAP
ent-ShuttleGunBeamstormMachineGun = LSE-800e "Beamstorm machine gun"
    .desc = Advanced stationary laser unit. Effective against live targets and electronics. Uses the power cage to fire, and has an extremely high rate of fire.
    .suffix = DO NOT MAP
