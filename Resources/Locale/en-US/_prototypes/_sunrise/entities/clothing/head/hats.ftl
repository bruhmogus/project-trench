...
ent-ClothingHeadCaptainCapWhite = white captain's cap
    .desc = A blindingly white cap. Grants +10 authority, -50 stealth, and an irresistible urge to say “That’s an order.”
ent-ClothingHeadCaptainCapBlack = black captain's cap
    .desc = A black cap for when you want to look like you planned the chaos. Warning: does not prevent clown incidents.
...
ent-ClothingHeadHatMaskN7 = mask 7
    .desc = You're quite tall.
ent-ClothingHeadHatMaskN8 = mask 8
    .desc = You just... You just wanna scream.
ent-ClothingHeadHatMaskN6 = mask 6
    .desc = SHAWN, FOR FUCK'S SAKE! WE ARE NOT YOUR KIND!
ent-ClothingHeadHatMaskN1 = mask 1
    .desc = You are mine. You will always be mine.
ent-ClothingHeadHatMaskN5 = mask 5
