...
ent-ClothingBeltMedicalElite = medical belt
    .desc = A sterile belt with many pockets for pills and other medications.
...
ent-ClothingBeltSyndicateUtility = syndicate utility belt
    .desc = A utility belt with a stiff lining, too many seams, and a buckle that looks newer than the rest.
ent-ClothingBeltSyndicateUtilityChameleon = chameleon syndicate utility belt
    .desc = A utility belt with a stiff lining, too many seams, and a buckle that never catches the light the same way twice.
    .suffix = Chameleon
