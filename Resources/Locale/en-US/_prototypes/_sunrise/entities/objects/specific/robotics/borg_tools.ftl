...
# [AUTO_EN]
ent-HandheldMassScannerBorg = mass scanner
    .desc = Handheld mass scanner powered by your own batteries.
# [AUTO_EN]
ent-RadioJammerSyndicateBorg = cyborg jammer
    .desc = Communication Jammer of the Syndicate.
    .suffix = Syndicate
